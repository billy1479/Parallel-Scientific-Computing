...
if __name__ == "__main__":
    ...
    parser.add_argument("--max-N", type=int, default=15, help="Maximum number of bodies")
    ...
    parser.add_argument("--executables", nargs='+', default=["./step-0", "./step-2"], 
