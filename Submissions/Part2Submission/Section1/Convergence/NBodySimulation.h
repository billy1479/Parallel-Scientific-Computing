...
class NBodySimulation {
 ...
 private:
  double** x_analytical; // Analytical solution positions
  double** v_analytical; // Analytical solution velocities
  bool useAnalytical;
  // double t;
  // double tFinal;
  // double tPlot;
 ...
 public:
  ...
  void updateAnalyticalSolution(double time);
  double calculateError();
  void printConvergenceData();
  void setUseAnalytical(bool flag) { useAnalytical = flag; };
  double computeError(double** x_num, double** x_ref, int numBodies);
   ...
   */
  void setUp (int argc, char** argv, double dt_ref);
