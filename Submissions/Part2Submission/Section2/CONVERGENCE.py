...
if __name__ == "__main__":
    ...
    parser.add_argument("--final-time", type=float, default=60.0, help="Final simulation time")
    parser.add_argument("--executable", default="./step-3", help="Executable name")
